	...
	<div class="container text-center" style="padding-bottom: 70px;">
		...
		<tbody>
			<?php
				...
				$totalEmpSQL = "select count(*) as broj FROM narudzbine";
				...
				$empSQL = "select * FROM narudzbine N inner join podkat P where N.kategorija_id=P.glavnakat_id order by id ASC LIMIT $startFrom, $showRecordPerPage";
				...
				while($row = $stmt->fetch())
				{
					...
					echo '<td><a class="btn btn-danger" href="obrisi.php?nid='.$row['id'].'"><i class="fas fa-trash"></i></a>';
					echo "</tr>";
				}
			?>
		</tbody>
