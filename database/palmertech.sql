...
(172, 'bbb', '1', '', 5, '5', 5, 'upload_image/280.jpeg');
...
(1, 'Dusan Rajkovic', 'dusan', 'dusan', 'Muski', 'dule.tagoe@gmail.com', '0643319866', 'Smederevo'),
...
INSERT INTO `korpa` (`id`, `korisnik_id`, `korisnik_imeprezime`, `artikal_id`, `artikal_naziv`, `artikal_cena`, `kolicina`, `datum`, `kategorija_id`, `uspesno`) VALUES
(1, 1, 'Dusan Rajkovic', 1, 'Comtrade Gamer Intel i5 4460', 83999, 1, '25-02-2019', 1, 1),
(2, 1, 'Dusan Rajkovic', 1, 'Comtrade Gamer Intel i5 4460', 83999, 1, '25-02-2019', 1, 1),
(3, 1, 'Dusan Rajkovic', 1, 'Comtrade Gamer Intel i5 4460', 83999, 1, '25-02-2019', 1, 1),
(4, 1, 'Dusan Rajkovic', 1, 'Comtrade Gamer Intel i5 4460', 83999, 1, '25-02-2019', 1, 1),
(5, 1, 'Dusan Rajkovic', 1, 'Comtrade Gamer Intel i5 4460', 83999, 1, '25-02-2019', 1, 1),
(6, 1, 'Dusan Rajkovic', 1, 'Comtrade Gamer Intel i5 4460', 83999, 1, '25-02-2019', 1, 1);
...
(25, 3, 'baba', 'upload_image/14-abstract-hd-wallpaper-338453.jpg');
...
INSERT INTO `reklamacije` (`reklamacija_id`, `korisnik_id`, `reklamirao`, `proizvod_za_reklamaciju`, `status_reklamacije`, `opis_reklamacije`) VALUES
(25, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(24, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(23, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(22, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(19, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(18, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(20, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk'),
(21, 1, 'Dusan Rajkovic', 'Comtrade Business Intel G1840', 'Pending', 'kkkkkkkkkkk');
...
--
ALTER TABLE `artikli`
  MODIFY `artikal_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;
--
-- AUTO_INCREMENT for table `kategorija`
--
ALTER TABLE `kategorija`
  MODIFY `kategorija_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
-- AUTO_INCREMENT for table `korisnik`
--
ALTER TABLE `korisnik`
  MODIFY `korisnik_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `podkat`
  MODIFY `podkat_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `reklamacije`
--
ALTER TABLE `reklamacije`
  MODIFY `reklamacija_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;COMMIT;
