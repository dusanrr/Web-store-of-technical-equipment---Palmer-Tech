...
<html lang="en">
     ...
     data-aos-easing="ease-in-sine">
				...
				<?php
					...
					{
							$putanja_do_slike = $row['kategorija_slika'];
							echo "	<div class=\"card my-3 text-center\" style=\"width:550px;\">
									<div class=\"card-header bg-dark text-white\">
					    			PALMER TECH 1
					  			</div>
							    <img class=\"card-img-top\" src=\"$putanja_do_slike\" style=\"height:250px;\" alt=\"Card image\" style=\"width:100%\">
							    <div class=\"card-body\">
							      <h4 class=\"card-title\">".$row['kategorija_ime']."</h4>
							      <!--<p class=\"card-text\">Some example text some example text. John Doe is an architect and engineer</p>-->
							    </div>
									<div class=\"card-footer text-muted\">";
					    			echo '<a class="btn btn-primary" href="podkat.php?kategorija='.$row['kategorija_id'].'&kategorijaime='.$row["kategorija_ime"].'&kategorijaslika='.$row['kategorija_slika'].'">VIEW</a>';
					  			echo "</div>
						  	</div>";
					}
					$conn = null;
