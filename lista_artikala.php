<?php session_start();
	...
	$kategorija=$_GET['podkatid'];

	$totalq="select count(*) \"total\" from artikli where artikal_podkat='$kategorija'";
...
<div class="container">
	...
	<h2 class="animated bounceInRight text-center"><?php echo $_GET['podkatnaziv'];?></h2><br><hr>
</div>
 ...
 data-aos-easing="ease-in-sine">
		...
		<?php
			...
			$query="select * from artikli where artikal_podkat='$kategorija' LIMIT ".$k .",".$page_per_page;
			...
			while($row = $stmt->fetch())
			{
					...
					<div class=\"card my-3 text-center\" >
							...
							<div class=\"card-footer text-muted\">";
								echo '<a class="btn btn-primary" href="podaci_o_artiklu.php?id='.$row['artikal_id'].'&kategorija='.$_GET['podkatnaziv'].'">VIEW</a>';
							echo "</div>
						</div></div>";
			}
			$conn = null;
