<?php session_start();
  ...
  $kategorija=$_GET['kategorija'];
	...
	$totalq="select count(*) \"total\" from podkat where glavnakat_id=".$_GET['kategorija'];
...
<div class="container">
	...
	<h2 class="animated bounceInRight text-center"><?php echo $_GET['kategorijaime'];?></h2><br><hr>
</div>
 ...
 data-aos-easing="ease-in-sine">
		...
		<?php
			...
			$query="select * from podkat where glavnakat_id='$kategorija' LIMIT ".$k .",".$page_per_page;
			...
			{
					$putanja_do_slike = $row['podkat_slika'];
					...
					<div class=\"card my-3 text-center\" >
							...
							<div class=\"card-body\">
								<h4 class=\"card-title\">".$row['podkat_naziv']."</h4>
								<!--<p class=\"card-text\">Some example text some example text. John Doe is an architect and engineer</p>-->
							</div>
							<div class=\"card-footer text-muted\">";
								echo '<a class="btn btn-primary" href="lista_artikala.php?podkatid='.$row['podkat_id'].'&podkatnaziv='.$row["podkat_naziv"].'&podkatslika='.$row['podkat_slika'].'">VIEW</a>';
							echo "</div>
						</div></div>";
			}
			$conn = null;
